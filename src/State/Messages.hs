...
addMessage :: UserPlace -> BS.ByteString -> AppHandler Bool
...
voteMessageUp :: UserPlace -> User -> BS.ByteString -> AppHandler Bool
...
voteMessageDown :: UserPlace -> User -> BS.ByteString -> AppHandler Bool
...
flagMessage :: UserPlace -> User -> BS.ByteString -> AppHandler Bool
